...
import 'package:unistay/provider_login_screen.dart';
import 'package:unistay/provider_registration_screen.dart';
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ProviderReg()),
                    );
                  },
                  child: const Text(
                    'Register',
